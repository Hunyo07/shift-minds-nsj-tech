    ...
    <div class="menu shadow bg-white" :class="{ hidden: is_menu_hidden }">
      ...
      <div class="p-3 p-md-4">
        <div class="d-flex flex-column gap-2">
          ...
          <!-- <router-link to="/home#request-quote" class="btn btn-default btn-lg">Contact</router-link> -->
          <!-- <router-link to="/blog" class="btn btn-default btn-lg">Blog</router-link> -->
          <!-- <router-link to="/careers" class="btn btn-default btn-lg">Careers</router-link> -->
          <!-- <a @click="scrollToQuoteSection" class="btn btn-default btn-lg">Contact</a> -->
          <!-- <router-link to="/#request-quote" class="nav-link">Contact</router-link> -->
          <!-- <a @click="$router.push('/home#request-quote')" class="btn btn-default btn-lg">Contact</a> -->
          <!-- <router-link to="#request-quote
            " class="btn btn-default btn-lg">Contact</router-link> -->
        </div>
      </div>
    </div>
  </header>
